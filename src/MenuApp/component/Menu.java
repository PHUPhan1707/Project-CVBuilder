...
import MenuApp.model.Model_Menu;
...
public class Menu extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        listMenu = new MenuApp.swing.ListMenu<>();

        panelMoving.setOpaque(false);

        jLabel1.setFont(new java.awt.Font("sansserif", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MenuApp/icon/logo.png"))); // NOI18N
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint g = new GradientPaint(0, 0, Color.decode("#A9FFAC"), 0, getHeight(), Color.decode("#23A661"));
        g2.setPaint(g);
    ...
    private MenuApp.swing.ListMenu<String> listMenu;
