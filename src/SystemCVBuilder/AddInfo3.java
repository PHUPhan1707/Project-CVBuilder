...
public class AddInfo3 extends JFrame {
        ...
        exportPDFButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    ImageIcon icon = new ImageIcon(getClass().getResource("/icons/template3.jpg"));
...
// Tạo một JLabel để hiển thị tuổi
                    ...
                    majorLabel.setBounds(790, 690, 400, 30);
                    ...
                    skill1Label.setBounds(680, 1130, 400, 30);
                    ...
                    skill2Label.setBounds(680, 1190, 400, 30);
                    ...
                    skill3Label.setBounds(680, 1250, 400, 30);
                    ...
                    experienceLabel.setBounds(800, 100, 400, 400);
                    ...
                    hobbyLabel.setBounds(700, 1580, 400, 30);
                    ...
                    achievementLabel.setBounds(700, 1450, 300, 60);
                    ...
                    try {
                        ...
                        if (resultSet.next()) {
                            ...
                            nameLabel.setBounds(100, 450, 400, 60);
                            ...
                            ageLabel.setBounds(100,690, 400, 30);

                            addressLabel.setText(address);
                            phoneLabel.setText(postCode);
                            nationalityLabel.setText("Nation:" + nationality);
                            emailLabel.setText(email);
                            universityLabel.setText("University:"+university);
                            skill1Label.setText("+Skill:" + skill1);
                            skill2Label.setText("+Skill:" + skill2);
                            skill3Label.setText("+Skill:" + skill3);
                            majorLabel.setText("+Major:" + major);
                            hobbyLabel.setText("Hobby:"+hobby);
                            achievementLabel.setText("Achievement:"+achievement);
                            ...
                            if (avatarData != null && avatarData.length > 0) {
                                ...
                                if (avatarIcon != null) {
                                    ...
                                    avatarLabel.setBounds(avatarLabel.getX() + 65, avatarLabel.getY() - 195, avatarLabel.getWidth() * 2, avatarLabel.getHeight() * 2);
                                } else {
